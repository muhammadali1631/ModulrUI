...
export const saveComponent = async (req, res) =>{
    try {
        ...
        if(user.role !== "admin"){
            ...
            if(existing){
                return res.status(400).json({message: "You already have a componentwith this name"})
            }
...
export const publishComponent = async (req,res) =>{
    try {
        ...
        const libPath = path.join(process.cwd(), "../modulrui-lib")
        ...
        component.npmPackage = "modulrui-lib"
