            ...
            >
              ...
              {!plan.disabled && (
                <p className="text-white/35 text-xs ">
                  {" "}
                  Payment gateway currently unavailable please Contact:{" "}
                  <a
                    href="https://mail.google.com/mail/?view=cm&fs=1&to=m.alishahzad2004@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Email Us: m.alishahzad2004@gmail.com
                  </a>
                </p>
              )}
            </motion.div>
