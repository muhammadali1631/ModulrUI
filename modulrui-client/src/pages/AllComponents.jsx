      ...
      >
        ...
        <div className="w-full max-w-md mx-auto text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <CodeBlock code={`npm install modulrui-lib`} lang="bash" />
          </div>
          <div>
            <p className="text-xs text-white/40 mb-2 flex items-center gap-1.5">
            ...
            <CodeBlock
              code={`import {ComponentName} from 'modulrui-lib'`}
              lang="jsx"
            />
          </div>
          <div>
            ...
            <CodeBlock
              code={`import { UserAvatar, PricingCard } from "modulrui-lib";
...
function DetailPanel({ component, onBack }) {
  ...
  const importCode = `import { ${component.name} } from "modulrui-lib";`;

  const usageCode = `import { ${component.name} } from "modulrui-lib";
                    ...
                    <table className="w-full text-xs">
                      ...
                      <tbody>
                        {component.props.map((p, i) => (
                          ...
                          >
                            <td className="px-4 py-2.5 font-mono text-[#3be8ff]">
                              {p}
                            </td>
...
function AllComponents() {
  ...
  const { allComponents } = useSelector((e) => e.user);
